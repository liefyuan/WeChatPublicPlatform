...
public class Tools {
     ...
     * @param value 需要提交的值
     */
    public static void postData( HttpServletResponse response, String value) throws IOException {
        String url = "http://www.liefyuan.top/weixin";
        response.sendRedirect(url+value);
    }
    /**
     * 获取ip地址
     * @param request
